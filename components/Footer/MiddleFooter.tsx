...
const MiddleFooter = () => {
  return (
    <div className="wrapper gap-6 flex flex-col lg:flex-row lg:justify-between pt-6 items-center pb-4">
      ...
      <div className="pb-4 lg:pb-0">
        ...
        <div className="flex justify-start md:justify-center lg:justify-start gap-6 mt-2">
